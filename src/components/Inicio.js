...
export const Inicio = () => {
    return (
        <div className='h-full w-screen bg-heroBg grayscale-5 opacity-90 bg-no-repeat bg-cover '>
            <Header />
            <div className="h-full flex flex-col my-0 md:my-6 lg:my-12 justify-between ">
                ...
                <motion.div initial={{
                    ...
                    <div className='w-2/5  space-y-10 bg-meshBg p-4 m-2 rounded-2xl opacity-90 flex flex-col shadow-md shadow-gray-700'>
                    ...
                    <div className='w-2/5 space-y-5 bg-meshBg p-4 m-2 rounded-2xl opacity-90 flex flex-col justify-around shadow-md shadow-gray-700'>
